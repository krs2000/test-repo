...
import mobile from "../img/phoneIcon.png";
  ...
  return (
   <div className="contact container d-flex flex-column align-items-center justify-content-mdcenter">
  ...
  return (
        ...
        <div className="contactIconsContainer mb-5 d-flex flex-column flex-md-row align-items-center justify-content-center">
