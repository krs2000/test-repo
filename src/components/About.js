            ...
            <div className="col-md-6">
              <div className="row m-0">
                <div className="col-md-12  justify-content-center">
                  <h3 className="col-12 col-md-6 ml-auto mt-5 mb-5  justify-content-start">
                    <strong> Offbeat motion </strong>is a video production studio founded by Rafał
                     Lipiński.
          </h3>
                  <article className="col-12 col-md-6 ml-auto mb-3 mt-5">
                  ...
                  <article className="col-12 col-md-6 ml-auto mt-3 mb-5">
                    <strong>
                      {" "}
                      <br />
